...
In fact, let's use this feature to select a subset of the data frame
with a more manageable number of columns. 

The result is a data frame with the same number of observations, but
fewer variables.

We will save this subset in a new variable called CAR-SUB.
